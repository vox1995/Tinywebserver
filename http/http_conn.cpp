...
const char *doc_root = "/home/vox/Desktop/TinyWebServer/root";
...
//同步线程登录校验
	...
	printf("sign out\n");
            ...
            if (users.find(name) != users.end() && users[name] == password)
            {
                ...
                if (!res)
                    strcpy(m_url, "/logOutSucess.html");
                else
                    strcpy(m_url, "/logOutError.html");
            }
            else
                strcpy(m_url, "/logOutError.html");
        }
